...
if ($op == 'delete') {
  $id = $_GET['id'];
  $sql1 = "delete from visi_misi where id= '$id'";
...
if ($op == 'edit') {
  $id = $_GET['id'];
  $sqldef = "select * from visi_misi where id = '$id'";
  ...
  if (isset($_FILES['image']['name'])) {
    ...
    if (move_uploaded_file($image_tmp, $folder_tujuan)) {
      if ($op == 'edit') { //untuk update
        $sql1 = "update visi_misi set image='$image',visi='$visi', misi='$misi' where id = '$id'";
        $q1 = mysqli_query($conn, $sql1);
        if ($q1) {
        ...
        $sql1 = "insert into visi_misi(image,visi,misi) values ('$image','$visi','$misi')";
        $q1 = mysqli_query($conn, $sql1);
        if ($q1) {
          ...
          <div class="card-body">
            ...
            <form action="" method="POST" enctype="multipart/form-data">
              ...
              <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                  <textarea class="form-control" rows="8" cols="50" id="visi" name="visi" required><?php echo $visi ?></textarea>
                </div>
              </div>
              <div class="mb-3 row">
                <label for="misi" class="col-sm-2 col-form-label">Misi</label>
                <div class="col-sm-10">
                  <textarea class="form-control" rows="8" cols="50" id="misi" name="misi" required><?php echo $misi ?></textarea>
                </div>
              </div>
              <div class="col-12">
