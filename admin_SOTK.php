...
if ($op == 'delete') {
  $id_pemerintah_desa = $_GET['id'];
  $sql1 = "delete from pemerintah_desa where id_pemerintah_desa= '$id_pemerintah_desa'";
...
if ($op == 'edit') {
  $id_pemerintah_desa = $_GET['id'];
  $sqldef = "select * from pemerintah_desa where id_pemerintah_desa = '$id_pemerintah_desa'";
  $q1 = mysqli_query($conn, $sqldef);
  $r1 = mysqli_fetch_array($q1);
  $id_pemerintah_desa = $r1['id_pemerintah_desa'];
  $image  = $r1['image'];
  $nama = $r1['nama'];
  $jabatan = $r1['jabatan'];

  if ($id_pemerintah_desa == '') {
    $error = "Data tidak ditemukan";
  }
}

if (isset($_POST['simpan'])) { // untuk create
  $id_pemerintah_desa = $_POST['id_pemerintah_desa'];
  $nama = $_POST['nama'];
  $jabatan = $_POST['jabatan'];

  if ($id_pemerintah_desa && $nama && $jabatan && isset($_FILES['image']['name'])) {
    ...
    if (move_uploaded_file($image_tmp, $folder_tujuan)) {
      if ($op == 'edit') { // Untuk update
        $sql1 = "update pemerintah_desa set nama='$nama', jabatan='$jabatan', image='$image' WHERE id_pemerintah_desa='$id_pemerintah_desa'";
        $q1 = mysqli_query($conn, $sql1);
        if ($q1) {
        ...
        $sql1 = "INSERT INTO pemerintah_desa(nama, jabatan, image) VALUES ('$nama', '$jabatan', '$image')";
        $q1 = mysqli_query($conn, $sql1);
        if ($q1) {
        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <form action="" method="POST" enctype="multipart/form-data">
              <div class="mb-3 row">
                <label for="id_pemerintah_desa" class="col-sm-2 col-form-label">ID SOTK</label>
                <div class="col-sm-10">
                  <input type="text" class="form-control" id="id_pemerintah_desa" name="id_pemerintah_desa" value="<?php echo $id_pemerintah_desa ?>" required>
                </div>
              </div>
              <div class="mb-3 row">
        ...
        <div class="card">
          ...
          <div class="card-body">
            <table class="table">
              ...
              <tbody>
                <?php
                $sql2 = "SELECT * FROM pemerintah_desa";
                ...
                ?>
                  <tr>
                    ...
                    <td scope="row">
                      <a href="?op=edit&id=<?php echo $id_pemerintah_desa ?>"><button type="button" class="btn btn-warning">Edit</button></a>
                      <a href="?op=delete&id=<?php echo $id_pemerintah_desa ?>" onclick="return confirm('Yakin mau delete data?')"><button type="button" class="btn btn-danger">Delete</button></a>
                    </td>
                  </tr>
                <?php
                }
