...
if ($op == 'delete') {
  ...
  $sql1 = "delete from pengumuman where id_pengumuman= '$id_pengumuman'";
...
if ($op == 'edit') {
  $id_pengumuman = $_GET['id'];
  $sqldef = "select * from pengumuman where id_pengumuman = '$id_pengumuman'";
  $q1 = mysqli_query($conn, $sqldef);
  $r1 = mysqli_fetch_array($q1);
  $id_pengumuman = $r1['id_pengumuman'];
  $image  = $r1['image'];
  $judul = $r1['judul'];
...
if (isset($_POST['simpan'])) { //untuk create
  ...
  if ($id_pengumuman && $judul && $deskripsi && isset($_FILES['image']['name'])) {
    ...
    if (move_uploaded_file($image_tmp, $folder_tujuan)) {
      if ($op == 'edit') { //untuk update
        $sql1 = "update pengumuman set image='$image',judul='$judul', deskripsi='$deskripsi' where id_pengumuman = '$id_pengumuman'";
        $q1 = mysqli_query($conn, $sql1);
        if ($q1) {
        ...
        $sql1 = "insert into pengumuman(id_pengumuman,image,judul,deskripsi) values ('$id_pengumuman','$image','$judul','$deskripsi')";
        $q1 = mysqli_query($conn, $sql1);
        if ($q1) {
      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <form action="" method="POST" enctype="multipart/form-data">
            <div class="mb-3 row">
              <label for="id_pengumuman" class="col-sm-2 col-form-label">ID SOTK</label>
              <div class="col-sm-10">
                <input type="text" class="form-control" id="id_pengumuman" name="id_pengumuman" value="<?php echo $id_pengumuman ?>" required>
              </div>
            </div>
            <div class="mb-3 row">
            ...
            <tbody>
              ...
              ?>
                <tr>
                  ...
                  <td scope="row">
                    <a href="?op=edit&id=<?php echo $id_pengumuman ?>"><button type="button" class="btn btn-warning">Edit</button></a>
                    <a href="?op=delete&id=<?php echo $id_pengumuman ?>" onclick="return confirm('Yakin mau delete data?')"><button type="button" class="btn btn-danger">Delete</button></a>
                  </td>
                </tr>
              <?php
              }
