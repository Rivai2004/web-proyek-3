...
if (isset($_POST['simpan'])) { //untuk create
  $sejarah = $_POST['sejarah'];
      ...
      if ($op == 'edit') { //untuk update
        $sql1 = "update sejarah set sejarah='$sejarah' where id = '$id'";
        $q1 = mysqli_query($conn, $sql1);
        if ($q1) {
        ...
        $sql1 = "insert into sejarah(sejarah) values ('$sejarah')";
        $q1 = mysqli_query($conn, $sql1);
        if ($q1) {
        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <form action="" method="POST" enctype="multipart/form-data">
              <div class="mb-3 row">
                <label for="misi" class="col-sm-2 col-form-label">Sejarah</label>
                <div class="col-sm-10">
                  <textarea class="form-control" rows="8" cols="50" id="sejarah" name="sejarah" required><?php echo $sejarah ?></textarea>
                </div>
              </div>
              <div class="col-12">
